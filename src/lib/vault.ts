...
function migrateState(state: AppState): AppState {
  return {
    ...
    academy: {
      ...
      dueDay: state.academy.dueDay || 10,
      ...
      contractBody: state.academy.contractBody ?? "",
      contractVersion: state.academy.contractVersion ?? 0,
      contractUpdatedAt: state.academy.contractUpdatedAt ?? "",
    },
