...
export const OPERATOR_LEADS_SQL = `-- Planilha de prospecção do dono do JiuPro. Só a service role lê.
...
Sou o Hugo, do JiuPro. É um sistema só para academia de Jiu-Jitsu: aluno, mensalidade no Pix de vocês, presença no tatame e faixa.
