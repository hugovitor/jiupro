...
export function DarkCanvas({
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-background text-foreground selection:bg-red-600 selection:text-white">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_75%_25%,rgba(220,38,38,0.16),transparent_32%),radial-gradient(circle_at_20%_70%,rgba(255,255,255,0.06),transparent_28%)] light:bg-[radial-gradient(circle_at_75%_25%,rgba(220,38,38,0.16),transparent_32%),radial-gradient(circle_at_20%_70%,rgba(17,17,17,0.04),transparent_28%)]" />
