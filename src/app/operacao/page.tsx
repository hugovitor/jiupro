    ...
    return (
      <DarkCanvas className="flex min-h-screen flex-col items-center justify-center px-5">
        ...
        <p className="mt-8 max-w-md text-center text-sm text-white/50">
          Este painel é do dono do JiuPro, não da academia. Entre com o e-mail da
          operação.
        </p>
      ...
      <div className="mx-auto max-w-6xl space-y-10 px-5 py-10">
        ...
        <section className="grid gap-4 lg:grid-cols-2">
          <article className="surface p-5">
            <h2 className="text-sm font-black">O que o cliente paga ao JiuPro</h2>
          ...
          <article className="surface p-5">
            ...
            <p className="mt-3 text-sm leading-6 text-white/50">
              ...
              Isso não passa no Stripe do JiuPro. Cupom daqui não altera a
